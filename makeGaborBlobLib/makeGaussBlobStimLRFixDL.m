...
function stimTex = makeGaussBlobStimLRFixDL(imSize,nWL,nCL,ori,phase,mpSize,sigma,jitter,dodots,gridStruct)
  
    % make sure nCL is even
    if(rem(nCL,2))
       error('Number of canceling points must be even');
    end
