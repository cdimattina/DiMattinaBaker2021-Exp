...
function [stimTex,nWL,nBL]  = makeRandThrowGaussStimFix(gaussInStruct)
    ...
    nWL         = gaussInStruct.nWL; 
    nCL         = gaussInStruct.nCL;
    ...
    % Make sure number of white dots and black dots is even
    if(rem(nWL,2))
        nWL = nWL + 1; 
    end
    if(rem(nBL,2))
