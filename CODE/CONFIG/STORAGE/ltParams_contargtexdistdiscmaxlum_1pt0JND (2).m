...
maxlumLevJNDval = str2num(input('enter texture maxlum JND: ','s'));
...
stim.pedestal.env.taper     = 0.2;       % boundary of disc
stim.pedestal.env.circtaper = 0.2;
stim.pedestal.env.edgetaper = 0.0;       % edge
stim.pedestal.lumLevJNDunits= 1; 
stim.pedestal.lumLev        =  lumLevJNDval*stim.pedestal.lumLevJNDunits;        % luminance level of disc. Will be set 
...
stim.blob.pW        = [1];
stim.blob.dens      = [0.5];
stim.blob.maxlumJNDunits = 1;            % Set maxlum at or slightly above JND
stim.blob.maxlum    = maxlumLevJNDval*stim.blob.maxlumJNDunits;       
