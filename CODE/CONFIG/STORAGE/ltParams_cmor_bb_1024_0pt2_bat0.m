...
stim.cmStimParams.carrPeriods    = [32]; 
stim.cmStimParams.carrOR         = [0 45 90 135 180 225 315]; 
...
stim.cmStimParams.doLong         = 1;  

stim.cmStimParams.nPatt          = 1024;
stim.cmStimParams.fracScale      = [1];

stim.cmStimParams.cmLevels       = [0:5:60];
stim.nLevels                     = length(stim.cmStimParams.cmLevels);

stim.nTrials        = 1000; % for debugging only - for real experiments increase to 1000
