...
stim.pedestal.lumLevJNDunits = 6; 
...
stim.lumLevels      = [0:100:1800];                           % In units of dimensionless luminance across diagonal
...
thisTexture = sprintf('../../makeTexMod/128x128/D%d.tif',111);
