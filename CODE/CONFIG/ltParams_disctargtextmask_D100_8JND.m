...
load(sprintf('../../ANALYSIS3/RESULTS/natTexBal_D100_LTB_%s.mat',subj)); 
...
stim.pedestal.lumLevJNDunits = 8; 
stim.pedestal.lumLev         = stim.pedestal.lumLev*stim.pedestal.lumLevJNDunits;        

                                        

stim.lumLevels      = [0:100:1400];                           % In units of dimensionless luminance across diagonal
