...
stim.category               = 'lumDiscPedestal';  

% Despite the terminology, in this file the pedestal is the foreground and
% the observer needs to ignore the dots 
...
[~,cue2ind] = min((threshstruct.dlPc -0.75).^2); 
stim.blob.maxlum        = threshstruct.dlStimLevelsPlot(cue2ind); 
clear threshstruct
...
stim.blob.maxlum    = stim.blob.maxlum*stim.blob.maxlumJNDunits;       
